...
FUNCTION _AGC_INIT {
    ...
    runOncePath("0:/AGC/LM/Memory/displayAddressing.ks").
    runOncePath("0:/AGC/LM/Memory/Memory.ks").

    runOncePath("0:/AGC/DSKY.ks").

    // after the DSKY is initilized, load programs

    runOncePath("0:/AGC/LM/Routines and Programs/programs.ks").
    runOncePath("0:/AGC/LM/Routines and Programs/routines.ks").
    runOncePath("0:/AGC/LM/Routines and Programs/extendedVerbs.ks").
