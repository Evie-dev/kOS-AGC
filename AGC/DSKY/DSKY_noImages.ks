...
// you will note that as of 13/12/23, i include a version named DSKY_images.ks
// DSKY_images.ks allows for images to be used with the DSKY
...
local useImages is false. // ill set this to false for now, feel free to set this to true if you want to see some potato quality DSKY textures lol (actually a lot more than 15, i need a hbox for every character, i think gonna ask the kOS discord on that though)
...
// row 4 - Register R2
    ...
    set _EL_DISPLAYREG2:style:width to 125.
...
// row 5 - Register R3
    ...
    set _EL_DISPLAYREG3:style:width to 125.
...
LOCAL FUNCTION ASSIGNTEXTURES {
    ...
    set DSKY:style:border:h to 0.
    set DSKY:style:border:v to 0.
    ...
    set _EL_COMPACTY:image to "AGC textures/EL DISP/COMPACTY".
    set _EL_VERBLBL:image to "AGC textures/EL DISP/VERB".
    set _EL_NOUNLBL:image to "AGC textures/EL DISP/NOUN".
    set _EL_PROG:image to "AGC textures/EL DISP/PROG".
...
LOCAL FUNCTION DSKY_LIGHTTEST {
    ...
    // DISPLAYS 88 in PROG, VERB and NOUN
